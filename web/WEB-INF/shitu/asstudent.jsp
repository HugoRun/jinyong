...
<%@ page pageEncoding="UTF-8"%><%@page import="com.ls.pub.config.GameConfig" %>
	...
	<%
		String apply_hint = (String) request.getAttribute("message");
		if (apply_hint != null) {
	%>
	<%=apply_hint%><br/>
	<%
	...
	%> 
	师傅:<%=vo.getPName() %> <% String aa = ShituConstant.getTeLevel(vo.getTe_level()); %>
	...
	<postfield name="te_name" value="<%=vo.getPName()%>" /> 
	</go>
	解除师徒关系
	</anchor>
	<br/>
