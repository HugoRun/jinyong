...
<%=hint %><br/>
<%} %>
请将结婚所需物品放在下面正确的位置上：<br/>
<%PlayerPropGroupVO ppv = (PlayerPropGroupVO)request.getAttribute("good1"); 
if(ppv!=null){
%>
...
物品栏</anchor>
<%} %>
<%PlayerPropGroupVO ppv3 = (PlayerPropGroupVO)request.getAttribute("good3"); 
if(ppv3!=null){
%>
<anchor><go method="post" href="<%=response.encodeURL(GameConfig.getContextPath()+"/jiehun.do")%>">
<postfield name="cmd" value="n3" />
...
<%} %>
<br/>
<%PlayerPropGroupVO ppv4 = (PlayerPropGroupVO)request.getAttribute("good4"); 
if(ppv4!=null){
%>
<anchor><go method="post" href="<%=response.encodeURL(GameConfig.getContextPath()+"/jiehun.do")%>">
<postfield name="cmd" value="n3" />
...
物品栏</anchor>
<%} %>
<%PlayerPropGroupVO ppv5 = (PlayerPropGroupVO)request.getAttribute("good5"); 
if(ppv5!=null){
%>
<anchor><go method="post" href="<%=response.encodeURL(GameConfig.getContextPath()+"/jiehun.do")%>">
<postfield name="cmd" value="n3" />
...
物品栏</anchor>
<%} %>
<%PlayerPropGroupVO ppv6 = (PlayerPropGroupVO)request.getAttribute("good6"); 
if(ppv6!=null){
%>
<anchor><go method="post" href="<%=response.encodeURL(GameConfig.getContextPath()+"/jiehun.do")%>">
<postfield name="cmd" value="n3" />
...
<anchor><go href="<%=response.encodeURL(GameConfig.getContextPath()+"/jiehun.do?cmd=n6")%>" method="get"></go>确定</anchor>
<br/>
