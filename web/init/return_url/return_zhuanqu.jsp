...
%>
<anchor>
<go href="<%=zhuanqu_url + "/gp/dl/login.do?" + login_params%>" method="get" ></go>
返回选区页面
</anchor>
<br />
<%
...
%>
<anchor>
<go href="<%=zhuanqu_url + "/tiao/login.do?" + login_params%>" method="get" ></go>
返回选区页面
</anchor>
<br />
<%
...
%>
<anchor>
<go href="http://3g.sina.com.cn/game/s/3g/index.php?tid=60&amp;did=43" method="get" ></go>
返回专区
</anchor>
<br />
<%
...
<anchor>
<go
	href="http://interface.juu.cn/new/no_pws_login.php?gameid=51&amp;username=<%=username%>&amp;time=<%=time%>&amp;sign=<%=sign%>" method="get" ></go>
返回专区
</anchor>
<br />
<%
		...
		String xsid = (String) request.getSession()
				.getAttribute("xsid");
%><anchor>
<go href="http://youvb.cn/txtl.jsp?xsid=<%=xsid%>" method="get" ></go>
返回专区
</anchor>
<br />
<%
...
%><anchor>
<go href="http://wap.wapok.cn/gogame.php?tid=12&amp;osid=<%=osid %>" method="get" ></go>
返回官网
</anchor>
<br />
<%
