...
%>
<anchor>
    <go href="<%=zhuanqu_url + ssid%>" method="get" />
    返回专区
</anchor>
<%
} else if (channel_id == Channel.DANGLE) {
    String login_params = (String) session.getAttribute("login_params");
    if (login_params != null && !login_params.isEmpty()) {
        String zhuanqu_url = GameConfig.getUrlOfZhuanqu();
%>
    <anchor>
    <go href="<%=zhuanqu_url + "/gp/dl/login.do?" + login_params%>" method="get" />
    返回选区页面
</anchor>
    <br/>
<%
...
%>
    <anchor>
    <go href="http://189hi.cn/plaf/wml/gacs.jw?act=gogame&amp;gameid=10" method="get" />
    返回当乐专区
</anchor>
<%
...
%>
    <anchor>
    <go href="<%=zhuanqu_url + "/tiao/login.do?" + login_params%>" method="get" />
    返回选区页面
</anchor>
    <br/>
<%
...
%>
    <anchor>
    <go href="<%=zhuanqu_url%>" method="get" />
    返回游乐
</anchor>
    <br/>
<%
...
%>
    <anchor>
    <go href="http://3g.sina.com.cn/game/s/3g/index.php?tid=60&amp;did=43" method="get" />
    返回专区
</anchor>
    <br/>
<%
...
<%
    ...
    String xsid = (String) request.getSession()
            .getAttribute("xsid");
%><anchor>
<go href="http://youvb.cn/txtl.jsp?xsid=<%=xsid%>" method="get" />
返回专区
</anchor>
    <br/>
<%
...
%><anchor>
<go href="http://wap.wapok.cn/gogame.php?tid=12&amp;osid=<%=osid %>" method="get" />
返回官网
</anchor>
    <br/>
<%
