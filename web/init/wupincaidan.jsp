...
<anchor>
    <go method="post"
        href="<%=GameConfig.getContextPath()%>/jsp/wrapinfo/wrapinfo_list_shu.jsp">
    ...
    <anchor>
    <go method="post"
        href="<%=GameConfig.getContextPath()%>/jsp/wrapinfo/wrapinfo_list.jsp">
        <postfield name="mapid" value="<%=mapid2%>"/>
        <postfield name="uPk" value="<%=uPk2%>"/>
        <postfield name="pPk" value="<%=pPk2%>"/>
        <postfield name="jumpterm" value="<%=jumpterm2%>"/>
    ...
    <anchor>
    <go method="post"
        href="<%=GameConfig.getContextPath()%>/jsp/wrapinfo/wrapinfo_list_zb.jsp">
        <postfield name="mapid" value="<%=mapid2%>"/>
        <postfield name="uPk" value="<%=uPk2%>"/>
        <postfield name="pPk" value="<%=pPk2%>"/>
        <postfield name="jumpterm" value="<%=jumpterm2%>"/>
    ...
    <anchor>
    <go method="post"
        href="<%=GameConfig.getContextPath()%>/jsp/wrapinfo/wrapinfo_list_rw.jsp">
        <postfield name="mapid" value="<%=mapid2%>"/>
        <postfield name="uPk" value="<%=uPk2%>"/>
        <postfield name="pPk" value="<%=pPk2%>"/>
        <postfield name="jumpterm" value="<%=jumpterm2%>"/>
    ...
    <anchor>
    <go method="post"
        href="<%=GameConfig.getContextPath()%>/jsp/wrapinfo/wrapinfo_list_qt.jsp">
        <postfield name="mapid" value="<%=mapid2%>"/>
        <postfield name="uPk" value="<%=uPk2%>"/>
        <postfield name="pPk" value="<%=pPk2%>"/>
        <postfield name="jumpterm" value="<%=jumpterm2%>"/>
