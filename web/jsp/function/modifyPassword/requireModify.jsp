...
<p>
	...
	<anchor>
	<go method="post"   href="<%=response.encodeURL(GameConfig.getContextPath()+"/modifyPassword.do?uPk="+uPk)%>">
	...
	<br/>
	<anchor>
	<go method="post" href="<%=response.encodeURL(GameConfig.getContextPath()+"/jsp/function/function.jsp")%>">
	</go>
	返回
	</anchor>
