...
<p>
	...
	<%
		...
		List list = communionService.getPublicChatInfoList(type);
	...
	<%
			...
			out.println(pageb.getFooter() + "<br/>");
		}
	%>
	<%@ include file="/init/caidan.jsp"%>
	<br />
	<input name="puTitle" type="text" maxlength="30" />
	<br />
	<anchor>
	<go method="post"
		href="<%=response.encodeURL(GameConfig.getContextPath()
