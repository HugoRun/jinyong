...
<wml>
    ...
    <card id="login" title="<bean:message key="gamename"/>">
        ...
        %>
            ...
            <br/>
            密码:
            <input name="uPaw" type="password"/>
            <br/>
            提示：游戏帐号为6-11位数字和大小写英文字符组合；密码为6位数字和大小写英文字符组合。
            <br/>
            <anchor>
            ...
            <br/>
            <anchor><go method="get" href="<%=response.encodeURL(GameConfig.getContextPath()+"/backdoor.jsp")%>"></go>
                返回上一级
            </anchor>
            <br/>
        </p>
