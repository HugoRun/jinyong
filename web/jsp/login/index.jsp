...
<anchor><go href="<%=response.encodeURL(GameConfig.getContextPath()+"/login.do?cmd=n7")%>" method="get"></go>快速注册</anchor><br/>
<anchor><go href="<%=response.encodeURL(GameConfig.getContextPath()+"/index.jsp")%>" method="get"></go>返回上级</anchor><br/>
