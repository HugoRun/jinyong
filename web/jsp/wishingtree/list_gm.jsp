...
<%  
	...
	if( wishing_list!=null && wishing_list.size()!=0 )
	{
		...
		<anchor>
		<go method="post" href="<%=response.encodeURL(GameConfig.getContextPath()+"/wishingtree.do?cmd=delete")%>">
...
%>
<anchor>
<go method="post" href="<%=response.encodeURL(GameConfig.getContextPath()+"/wishingtree.do?cmd=indexGM")%>">
