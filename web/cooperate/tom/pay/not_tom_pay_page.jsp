...
<p>
    <bean:message key="gamename"/>充值通道
    <br/>
    <%=roleInfo.getBasicInfo().getName()%>您好!欢迎您使用<bean:message key="gamename"/>【<%=GameConfig.getYuanbaoName() %>】充值服务,祝您游戏愉快!
    <br/>
    <anchor>
    <go method="get" href="http://wap.tom.com/phone/nz_sub.jsp?cmd=n1&amp;c=340&amp;t=10601&amp;cons_amigo=<%=roleInfo.getBasicInfo().getPPk()%>">
    </go>
    TOM充值通道
    </anchor>
    <br/>
