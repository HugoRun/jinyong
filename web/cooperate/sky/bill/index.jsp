...
<anchor><go href="<%=response.encodeURL(sky_url+"?skyid="+skyid+"&amp;cpurl="+cpurl+"&amp;appid=423007&amp;f=423007")%>" method="get"></go>K币充值</anchor><br/>
<br/>
<anchor>
...
-------------------<br/>
手动兑换<br/>
请输入K币兑换数量:<input name="kbamt" type="text" format="*N" size="4"/><br/>
<anchor>
<go method="post" href="<%=response.encodeURL(GameConfig.getContextPath()+"/sky/bill.do?cmd=n1")%>">
