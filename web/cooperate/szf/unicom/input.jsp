...
<card id="index" title="联通一卡充充值方式">
<p>
联通一卡充充值【<%=GameConfig.getYuanbaoName() %>】快速通道<br/>
您选择了使用<%=money %>元面值的联通一卡充充值卡为本游戏帐号充值<br/>
请输入您的充值卡卡号:<br/>
<input name="code" maxlength="15"></input>(15位数字)<br/>
请输入您的充值卡密码:<br/>
<input name="psw" maxlength="19"></input>(19位数字)<br/>
<anchor>
...
帮助信息<br/>
1.本服务支持5、6、10、15、30、50、60、100元联通一卡充充值卡<br/>
2.联通一卡充充值卡卡号为15位，密码为19位<br/>
3.您可以在全国各地报刊亭,网吧等购买联通一卡充充值卡为本游戏充值.<br/>
