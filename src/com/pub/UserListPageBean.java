...
public class UserListPageBean {
	    ...
	    public String insertTag() {
	    	StringBuffer text=new StringBuffer("共");
	        text.append(total);
	        text.append("个 ");
	        text.append(index).append("/").append(page_num);
	        text.append(" <input name='pageNo'  format='*N' type='text' maxlength='4' size='2' />页<anchor><go href='");
	    ...
	    public String insertWEBTag() {
	        ...
	        text.append(this.url);
	        text.append("'><input name='pageNo'  format='*N' type='text' maxlength='4' size='2' />页");
	        
	        text.append("<input value='跳到' type='submit'></form>");
	       	return text.toString();
	    } 
	   /**
	    * 打印出翻页连接
