...
public class ShituService {
    private final ShituDao shituDao;
...
//	}
    ...
    public List<Shitu> findStudent(int page) {
        ...
        if (ShituConstant.TEACHER != null) {
            synchronized (ShituConstant.STUDENT) {
                list = ShituConstant.STUDENT.subList((page - 1) * Constant.EVERY_PAGE_COUNT, page * Constant.EVERY_PAGE_COUNT > ShituConstant.STUDENT.size() ? ShituConstant.STUDENT.size() : page * Constant.EVERY_PAGE_COUNT);
            }
        }
        return list;
    }
    ...
    public List<Shitu> findTeacher(int page) {
        ...
        if (ShituConstant.TEACHER != null) {
            synchronized (ShituConstant.TEACHER) {
                list = ShituConstant.TEACHER.subList((page - 1) * Constant.EVERY_PAGE_COUNT, page * Constant.EVERY_PAGE_COUNT > ShituConstant.TEACHER.size() ? ShituConstant.TEACHER.size() : page * Constant.EVERY_PAGE_COUNT);
            }
        }
        return list;
    }
