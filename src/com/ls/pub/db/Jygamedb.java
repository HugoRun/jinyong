...
public class Jygamedb {
	...
	public Connection getConnetion() {
		try {
			String url = "jdbc:mysql://192.168.1.102:3306/jygame?autoReconnect=true";
			//url = "jdbc:mysql://127.0.0.1:3306/jygame?autoReconnect=true";
			Class.forName("com.mysql.jdbc.Driver");
			con = DriverManager.getConnection(url,"jygame", "jygame");
			return con;
		} catch (Exception e) {
	 ...
	 * stub SqlData con=new SqlData(); String sql="insert into affiche
