...
public class PlayerEquipDao extends BasicDaoSupport<PlayerEquipVO> {
    ...
    public void updateEquipAttri(PlayerEquipVO equip) {
        ...
        sql.append("wxAttrisStr = ?, w_zb_grade = ?, w_hp = ?, w_mp = ?, inlayPropStr = ?, left_effect_hole_num = ?, cur_endure = ?, ");
    ...
    public void deleteByEquip(int p_pk, int equip_id) {
        String sql = "DELETE FROM u_part_equip WHERE p_pk = " + p_pk + " AND equip_id=" + equip_id + " AND w_type =0 AND w_quality=0 LIMIT 1";
        logger.debug(sql);
        DBConnection dbConn = new DBConnection(DBConnection.GAME_USER_DB);
        conn = dbConn.getConn();
        try {
    ...
    public int deleteByID(int p_pk, int pw_pk) {
        int deleteValue = 0;
        String sql = "DELETE FROM u_part_equip WHERE pw_pk=" + pw_pk + " AND p_pk = " + p_pk;
        logger.debug(sql);
        DBConnection dbConn = new DBConnection(DBConnection.GAME_USER_DB);
        conn = dbConn.getConn();
        try {
    ...
    public List<PlayerEquipVO> getRankList(int... equip_type_list) {
        ...
        String sql = "SELECT * FROM u_part_equip WHERE equip_type IN (" + sb + ") AND w_level!=100 ORDER BY rank_key desc,hole_num desc,create_time LIMIT 10";
    ...
    public void updateCurEndure(int pw_pk, int cur_endure) {
        String sql = "UPDATE u_part_equip SET cur_endure = " + cur_endure + " WHERE pw_pk = " + pw_pk;
        logger.debug(sql);
        DBConnection dbConn = new DBConnection(DBConnection.GAME_USER_DB);
        conn = dbConn.getConn();
        try {
    ...
    public void updateEquipGrade(int pw_pk, int cur_grade) {
        String sql = "UPDATE u_part_equip SET w_zb_grade = " + cur_grade + " WHERE pw_pk = " + pw_pk;
        logger.debug(sql);
        DBConnection dbConn = new DBConnection(DBConnection.GAME_USER_DB);
        conn = dbConn.getConn();
        try {
