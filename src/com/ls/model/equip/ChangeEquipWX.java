...
public class ChangeEquipWX extends EquipProduct {
    // 五行转换需要的材料
    private static final int material1_id = 106;
    // 升级必须材料id列表
    private static final int[] upgrade_material_id_list = {material1_id};
    ...
    public String selectEquip(PlayerEquipVO select_equip) {
        ...
        // 设置需要的材料
        this.setNeedMaterials(upgrade_material_id_list, need_material_num);
        return null;
    }
