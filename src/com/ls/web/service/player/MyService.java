...
public interface MyService {
     ...
     */
    void addDear(int p_pk, String name);
...
//	public int addTeamEffect(int P_PK);
     ...
     * @return
     */
    int shareExp(int p_pk, int level, int exp);


    void addBloodMax(PartInfoVO player);


    /**
     * 查看自己作为徒弟时,师父是否也在线
     */
    boolean isTeaOnline(int p_pk);
