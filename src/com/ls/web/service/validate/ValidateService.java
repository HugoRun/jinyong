...
public class ValidateService {
    ...
    public static String validateCreateRole(String uPk, String role_name, String sex, String race) {
        ...
        if (!StringUtils.isNumeric(sex) || Integer.parseInt(sex) > 2 || Integer.parseInt(sex) < 1) {
            return "非法性别";
        }
...
*/
    ...
    public static String validateRace(String race) {
        if (!StringUtils.isNumeric(race) || Integer.parseInt(race) > 2 || Integer.parseInt(race) < 1) {
            return "非法种族";
        }
        return null;
    }
