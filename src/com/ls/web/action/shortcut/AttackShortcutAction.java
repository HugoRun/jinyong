...
public class AttackShortcutAction extends DispatchAction {
    ...
    public ActionForward n2(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        ShortcutService shortcutService = new ShortcutService();
        shortcutService.updateShortcut(Integer.parseInt(sc_pk), Integer.parseInt(type), Integer.parseInt(operate_id), p_pk);

        List<ShortcutVO> shortcuts = shortcutService.getByPpk(Integer.parseInt(p_pk));
    ...
    public ActionForward n6(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        List cures = goodsService.getDisdinctAndBattleUsableProps(Integer.parseInt(p_pk), Wrap.CURE);
    ...
    public ActionForward prop(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String p_pk = (String) request.getSession().getAttribute("pPk");
        String sc_pk = request.getParameter("sc_pk");
        String pk = request.getParameter("pk");
        request.setAttribute("pk", pk);
        ...
        List cures = goodsService.getDisdinctAttackPetProps(Integer.parseInt(p_pk), PropType.GETPETPROP);
