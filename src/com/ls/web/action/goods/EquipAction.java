...
public class EquipAction extends ActionBase {
     ...
     * 可以保护的装备列表
     */
    public ActionForward protectEquipList(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String pPk = (String) request.getSession().getAttribute("pPk");
        String page_no = request.getParameter("page_no");
        if (page_no == null || page_no.isEmpty()) {
            page_no = "1";
        }
     ...
     * 保护装备提示
     */
    public ActionForward protectHint(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        request.setAttribute("pg_pk", request.getParameter("pg_pk"));
     ...
     * 保护装备
     */
    public ActionForward protect(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
     ...
     * 可以提升装备品质的装备列表
     */
    public ActionForward qualityEquipList(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String pg_pk = request.getParameter("pg_pk");
     ...
     * 提升装备品质提示
     */
    public ActionForward upgradeQualityHint(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        request.setAttribute("pwPk", request.getParameter("pwPk"));
        request.setAttribute("pg_pk", request.getParameter("pg_pk"));
        request.setAttribute("page_no", request.getParameter("page_no"));
     ...
     * 提升装备品质
     */
    public ActionForward upgradeQuality(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        GoodsService goodsService = new GoodsService();
        EquipService equipService = new EquipService();
     ...
     * 绑定的装备列表
     */
    public ActionForward bindEquipList(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String pPk = (String) request.getSession().getAttribute("pPk");
        String page_no = request.getParameter("page_no");
        if (page_no == null || page_no.equals("")) {
            page_no = "1";
     ...
     * 解除绑定提示
     */
    public ActionForward unbindHint(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        request.setAttribute("pg_pk", request.getParameter("pg_pk"));
        request.setAttribute("pwPk", request.getParameter("pwPk"));
        request.setAttribute("page_no", request.getParameter("page_no"));
     ...
     * 解除绑定
     */
    public ActionForward unbind(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        GoodsService goodsService = new GoodsService();
        EquipService equipService = new EquipService();
     ...
     * 破损装备列表
     */
    public ActionForward badEquipList(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String pPk = (String) request.getSession().getAttribute("pPk");
        String page_no = request.getParameter("page_no");
        if (page_no == null || page_no.equals("")) {
            page_no = "1";
     ...
     * 修复破损装备提示
     */
    public ActionForward maintainBadHint(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        request.setAttribute("pg_pk", request.getParameter("pg_pk"));
        request.setAttribute("pwPk", request.getParameter("pwPk"));
        request.setAttribute("page_no", request.getParameter("page_no"));
     ...
     * 修复破损装备
     */
    public ActionForward maintainBad(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        GoodsService goodsService = new GoodsService();
        EquipService equipService = new EquipService();
    ...
    //********************************(通过道具)修理身上全部装备
    public ActionForward propMaintainIndex(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    public ActionForward propMaintain(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
    ...
    //********************************(通过菜单)修理身上全部装备
    public ActionForward maintainIndex(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        if (maintain_fee == 0) {
            ...
            if (roleEntity.getBasicInfo().getCopper() < maintain_fee) super.setHint(request, "你的金钱不足,无法修复");
        }
        request.setAttribute("feeDes", ExchangeUtil.getMoneyDes(maintain_fee));
        return mapping.findForward("maintain_index");
    }

    public ActionForward maintainAll(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        RoleEntity roleEntity = this.getRoleEntity(request);
     ...
     * 可以打孔的装备列表
     */
    public ActionForward punchEquipList(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String pPk = (String) request.getSession().getAttribute("pPk");
        String page_no = request.getParameter("page_no");
        if (page_no == null || page_no.equals("")) {
            page_no = "1";
     ...
     * 打孔提示
     */
    public ActionForward punchHint(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        request.setAttribute("pwPk", request.getParameter("pwPk"));
     ...
     * 打孔
     */
    public ActionForward punch(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        GoodsService goodsService = new GoodsService();
     ...
     * 可以镶嵌的装备列表
     */
    public ActionForward inlayEquipList(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String pPk = (String) request.getSession().getAttribute("pPk");
        String page_no = request.getParameter("page_no");
        if (page_no == null || page_no.equals("")) {
            page_no = "1";
     ...
     * 镶嵌宝石列表
     */
    public ActionForward inlayStoneList(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        GoodsService goodsService = new GoodsService();
     ...
     * 镶嵌提示
     */
    public ActionForward inlayHint(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        request.setAttribute("pwPk", request.getParameter("pwPk"));
     ...
     * 镶嵌
     */
    public ActionForward inlay(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        GoodsService goodsService = new GoodsService();
     ...
     * 升级,五行转换首页面
     */
    public ActionForward productIndex(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        RoleEntity roleEntity = this.getRoleEntity(request);
     ...
     * 增加成功率的宝石列表
     */
    public ActionForward stoneList(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        GoodsService goodsService = new GoodsService();
     ...
     * 输入成功率宝石数量
     */
    public ActionForward inputStoneNum(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String propId = request.getParameter("propId");
     ...
     * 输入保底宝石数量
     */
    public ActionForward useProtStoneHint(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        GoodsService goodsService = new GoodsService();
     ...
     * 使用保底宝石
     */
    public ActionForward useProtStone(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String propId = request.getParameter("propId");
     ...
     * 使用成功率宝石
     */
    public ActionForward useRateStone(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        String propId = request.getParameter("propId");
