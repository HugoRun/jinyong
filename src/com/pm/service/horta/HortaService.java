...
public class HortaService {
     ...
     * @param roleEntity
     */
    public String checkAbleList(List<HortaVO> horList, List<HortaVO> ableList, List<HortaVO> unAbleList, RoleEntity roleEntity) {
        String hint = null;
...
//				// 如果不能领取
    ...
    private boolean isUseAble(RoleEntity roleEntity, HortaVO hortaVO) {
        ...
        return hint == null || hint.equals("") || hint.equals("null");
    }
     ...
     * @return
     */
    private String checkHasEnoughWrapSpare(HortaVO hortaVO, RoleEntity roleEntity) {
